...
import 'package:pratap_s_application1/core/app_export.dart';
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildScreenTitle(
                              context,
                              userLoginText: "Super Flash Sale".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.superFlashSaleScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Favorite Product".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.favoriteProductScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Product Detail".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.productDetailScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Review Product".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.reviewProductScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Write Review Fill".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.writeReviewFillScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Notification".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.notificationScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Notification Offer".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.notificationOfferScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Notification Feed".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.notificationFeedScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Notification Activity".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.notificationActivityScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Search".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.searchScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Search Result".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.searchResultScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Search Result No Data Found".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.searchResultNoDataFoundScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "List Category".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.listCategoryScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Sort By".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.sortByScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Filter".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.filterScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Ship To".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.shipToScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Payment Method".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.paymentMethodScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Choose Credit Or Debit Card".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.chooseCreditOrDebitCardScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              userLoginText: "Success Screen".tr,
                              onTapScreenTitle: () =>
